...
const projectInfo= [
    ...
    },
    {
        ...
        description: "Organizations can manage artifacts (files stored in AWS S3 bucket), and projects. Organizations can create employee accounts by sending the new member an email with a one time link which will allow the user to finish creating their account",
    ...
    },
    {
        ...
        used: "Ruby on Rails, Auth with Devise, image upload handled with AWS S3 bucket",
        link: "https://photo-app.fly.dev/"
    },
    {
        name: "University App",
        description: "Mockup for a university site with a listing for courses, information page, a student index, profiles",
